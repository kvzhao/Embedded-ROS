...
#if STM32_DMA2D_USE_DMA2D && !STM32_HAS_DMA2D
#error "DMA2D not present in the selected device"
#endif

#if DMA2D_USE_MUTUAL_EXCLUSION && !CH_USE_MUTEXES && !CH_USE_SEMAPHORES
#error "DMA2D_USE_MUTUAL_EXCLUSION requires CH_USE_MUTEXES and/or CH_USE_SEMAPHORES"
#endif
...
#if DMA2D_USE_WAIT || defined(__DOXYGEN__)
